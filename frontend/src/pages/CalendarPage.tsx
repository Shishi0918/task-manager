...
export const CalendarPage = ({ onNavigateToTemplateCreator, onNavigateToYearlyTaskCreator, onNavigateToSpotTaskCreator, onNavigateToWeeklyTaskCreator, onNavigateToOrganization }: CalendarPageProps) => {
  const { user } = useAuth();
